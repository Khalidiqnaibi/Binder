...
intents =json.loads(open("C:/Users/khaaf/Desktop/code/ash_app/src/ash_ai/comm.json").read())
...
pickle.dump(words, open('commwords.pkl', 'wb'))
pickle.dump(classes, open('commclasses.pkl', 'wb'))
...
# saving the model
model.save("chatbotcomms.h5", hist)
