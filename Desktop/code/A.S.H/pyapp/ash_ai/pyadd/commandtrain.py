...
intents =json.loads(open("C:/Users/khaaf/Desktop/code/ash_app/src/ash_ai/command.json").read())
...
pickle.dump(words, open('cmndwords.pkl', 'wb'))
pickle.dump(classes, open('cmndclasses.pkl', 'wb'))
...
# saving the model
model.save("chatbotcmnd.h5", hist)
