...
intents =json.loads(open("C:/Users/khaaf/Desktop/code/ash_app/src/ash_ai/intents.json").read())
...
pickle.dump(words, open('intswords.pkl', 'wb'))
pickle.dump(classes, open('intsclasses.pkl', 'wb'))
...
# saving the model
model.save("chatbotints.h5", hist)
