...
intents =json.loads(open("C:/Users/khaaf/Desktop/code/A.S.H/pyapp/ash_ai/perdb.json").read())
...
pickle.dump(words, open('peinfwords.pkl', 'wb'))
pickle.dump(classes, open('peinfclasses.pkl', 'wb'))
...
# saving the model
model.save("chatbotpeinf.h5", hist)
