...
intents =json.loads(open("C:/Users/khaaf/Desktop/code/A.S.H/pyapp/ash_ai/actvdb.json").read())
...
pickle.dump(words, open('actvwords.pkl', 'wb'))
pickle.dump(classes, open('actvclasses.pkl', 'wb'))
...
# saving the model
model.save("chatbotactv.h5", hist)
